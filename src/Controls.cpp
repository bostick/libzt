...
#endif
{
    ...
    SETTHREADNAME(ZTS_EVENT_CALLBACK_THREAD_NAME);

    INST("thread starting %s", ZTS_EVENT_CALLBACK_THREAD_NAME);
...
#endif
{
    ...
    SETTHREADNAME(ZTS_SERVICE_THREAD_NAME);

    INST("thread starting %s", ZTS_SERVICE_THREAD_NAME);
